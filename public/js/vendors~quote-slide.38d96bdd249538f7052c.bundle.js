(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~quote-slide"],{
  ...
  return function (e) {
    ...
    */
    ...
    !function (t, n) {
      ...
      function a(e) {
        return null == e ? e + "" : "object" == _typeof(e) || "function" == typeof e ? me[ve.call(e)] || "object" : _typeof(e);
      }
      ...
      function _(e, t, n, i) {
        ...
        if (c && c[3] !== u) {
          for (l /= 2, u = u || c[3], c = +l || 1; s--;) {
            ke.style(e, t, c + u), (1 - o) * (1 - (o = a() / l || .5)) <= 0 && (s = 0), c /= o;
          }
      ...
      function T(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++) {
          i = e[o], i.style && (n = i.style.display, t ? ("none" === n && (r[o] = Ue.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && Qe(i) && (r[o] = C(i))) : "none" !== n && (r[o] = "none", Ue.set(i, "display", n)));
        }
      ...
      function S(e, t, n, i, r) {
        for (var o, s, l, u, c, h, p = t.createDocumentFragment(), d = [], f = 0, g = e.length; f < g; f++) {
          if (o = e[f], o || 0 === o) if ("object" === a(o)) ke.merge(d, o.nodeType ? [o] : o);else if (ot.test(o)) {
            for (s = s || p.appendChild(t.createElement("div")), l = (nt.exec(o) || ["", ""])[1].toLowerCase(), u = rt[l] || rt._default, s.innerHTML = u[1] + ke.htmlPrefilter(o) + u[2], h = u[0]; h--;) {
              s = s.lastChild;
            }
        ...
        for (p.textContent = "", f = 0; o = d[f++];) {
          if (i && ke.inArray(o, i) > -1) r && r.push(o);else if (c = ke.contains(o.ownerDocument, o), s = E(p.appendChild(o), "script"), c && k(s), n) for (h = 0; o = s[h++];) {
      ...
      function H(e, t, n, i) {
        ...
        if (p && (r = S(t, e[0].ownerDocument, !1, e, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
          for (a = ke.map(E(r, "script"), L), l = a.length; h < p; h++) {
            u = r, h !== d && (u = ke.clone(u, !0, !0), l && ke.merge(a, E(u, "script"))), n.call(e[h], u, h);
          }

          if (l) for (c = a[a.length - 1].ownerDocument, ke.map(a, z), h = 0; h < l; h++) {
            u = a[h], it.test(u.type || "") && !Ue.access(u, "globalEval") && ke.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? ke._evalUrl && ke._evalUrl(u.src) : s(u.textContent.replace(dt, ""), c, u));
          }
        }
      ...
      function q(e, t, n) {
        for (var i, r = t ? ke.filter(t, e) : e, o = 0; null != (i = r[o]); o++) {
          n || 1 !== i.nodeType || ke.cleanData(E(i)), i.parentNode && (n && ke.contains(i.ownerDocument, i) && k(E(i, "script")), i.parentNode.removeChild(i));
        }
      ...
      function F(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2) {
          "margin" === n && (l += ke.css(e, n + Je[s], !0, r)), i ? ("content" === n && (l -= ke.css(e, "padding" + Je[s], !0, r)), "margin" !== n && (l -= ke.css(e, "border" + Je[s] + "Width", !0, r))) : (l += ke.css(e, "padding" + Je[s], !0, r), "padding" !== n ? l += ke.css(e, "border" + Je[s] + "Width", !0, r) : a += ke.css(e, "border" + Je[s] + "Width", !0, r));
        }
      ...
      function Q(e, t) {
        ...
        for (n in e) {
          if (i = y(n), r = t[i], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), s = ke.cssHooks[i], s && "expand" in s) {
      ...
      function K(e, t, n) {
        var i,
          ...
          for (var t = Ct || Y(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; s < l; s++) {
            u.tweens[s].run(o);
          }
        ...
        for (Q(c, u.opts.specialEasing); o < s; o++) {
          if (i = K.prefilters[o].call(u, e, c, u.opts)) return _e(i.stop) && (ke._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
        }
      ...
      function ie(e, t, n, i) {
        ...
        if (Array.isArray(t)) ke.each(t, function (t, r) {
          n || Ht.test(e) ? i(e, r) : ie(e + "[" + ("object" == _typeof(r) && null != r ? t : "") + "]", r, n, i);
        });else if (n || "object" !== a(t)) i(e, t);else for (r in t) {
          ie(e + "[" + r + "]", t[r], n, i);
        }
      }
      ...
      ke.fn = ke.prototype = {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == _typeof(s) || _e(s) || (s = {}), a === l && (s = this, a--); a < l; a++) {
          if (null != (e = arguments[a])) for (t in e) {
            n = s[t], i = e[t], s !== i && (u && i && (ke.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && ke.isPlainObject(n) ? n : {}, s[t] = ke.extend(u, o, i)) : void 0 !== i && (s[t] = i));
          }
        }
      ...
      */
      function (e) {
          ...
          if (!i && ((t ? t.ownerDocument || t : I) !== L && $(t), t = t || L, O)) {
            ...
            if (_.qsa && !V[e + " "] && (!P || !P.test(e))) {
              if (1 !== f) p = t, c = e;else if ("object" !== t.nodeName.toLowerCase()) {
                for ((a = t.getAttribute("id")) ? a = a.replace(be, _e) : t.setAttribute("id", a = R), u = k(e), o = u.length; o--;) {
                  u[o] = "#" + a + " " + d(u[o]);
                }
        ...
        function f(e, t, n) {
          ...
          return t.first ? function (t, n, r) {
            ...
            if (l) {
              ...
              if (1 === t.nodeType || s) if (h = t[R] || (t[R] = {}), c = h[t.uniqueID] || (h[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;else {
        ...
        function y(e, t, n, r, o, s) {
          return r && !r[R] && (r = y(r)), o && !o[R] && (o = y(o, s)), i(function (i, s, a, l) {
            var u,
                ...
                w = n ? o || (i ? e : f || r) ? [] : s : y;
            if (n && n(y, w, a, l), r) for (u = v(w, d), r(u, [], a, l), c = u.length; c--;) {
              (h = u[c]) && (w[d[c]] = !(y[d[c]] = h));
            }
            ...
            if (i) {
              if (o || e) {
                ...
                for (c = w.length; c--;) {
                  (h = w[c]) && (u = o ? ee(i, h) : p[c]) > -1 && (i[u] = !(s[u] = h));
                }
              }
        ...
        function x(e, n) {
          var r = n.length > 0,
            ...
            for (u && (N = _s === L || _s || u); f !== b && null != (c = w[f]); f++) {
              if (o && c) {
                for (h = 0, _s || c.ownerDocument === L || ($(c), a = !O); p = e[h++];) {
                  if (p(c, _s || L, a)) {
                    l.push(c);
                    break;
                  }
              ...
              return 1 === i && 0 === r ? function (e) {
                ...
                if (m) {
                  ...
                  if (f = [s ? m.firstChild : m.lastChild], s && y) {
                    for (p = m, h = p[R] || (p[R] = {}), c = h[p.uniqueID] || (h[p.uniqueID] = {}), u = c[e] || [], d = u[0] === B && u[1], w = d && u[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (w = d = 0) || f.pop();) {
        ...
        return p.prototype = C.filters = C.pseudos, C.setFilters = new p(), k = t.tokenize = function (e, n) {
          ...
          for (a = e, l = [], u = C.preFilter; a;) {
            ...
            for (s in C.filter) {
              !(r = de[s].exec(a)) || u[s] && !(r = u[s](r)) || (i = r.shift(), o.push({
                value: i,
                type: s,
                matches: r
              }), a = a.slice(i.length));
      ...
      var Le,
        ...
        if (n = n || Le, "string" == typeof e) {
          ...
          if (i[1]) {
            if (t = t instanceof ke ? t[0] : t, ke.merge(this, ke.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ce, !0)), $e.test(i[1]) && ke.isPlainObject(t)) for (i in t) {
                ...
                return function () {
                  var a = this,
                    ...
                    if (!(e < s)) {
                      ...
                      u = n && ("object" == _typeof(n) || "function" == typeof n) && n.then, _e(u) ? r ? u.call(n, o(s, t, d, r), o(s, t, f, r)) : (s++, u.call(n, o(s, t, d, r), o(s, t, f, r), o(s, t, d, t.notifyWith))) : (i !== d && (a = void 0, l = [n]), (r || t.resolveWith)(a, l));
                    }
                  },
                      c = r ? u : function () {
                    try {
      ...
      var Ie = function Ie(e, t, n, i, r, o, s) {
        ...
        } else if (void 0 !== i && (r = !0, _e(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function t(e, _t2, n) {
      ...
      ke.extend({
        ...
        data: function data(e, t) {
          ...
          if (void 0 === e) {
            if (this.length && (r = Ve.get(o), 1 === o.nodeType && !Ue.get(o, "hasDataAttrs"))) {
              for (n = s.length; n--;) {
                s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = y(i.slice(5)), b(o, i, r[i])));
              }
        ...
        promise: function promise(e, t) {
          ...
          for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) {
            n = Ue.get(o[s], e + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
          }
      ...
      ke.event = {
        ...
        add: function add(e, t, n, i, r) {
          ...
          if (m) for (n.handler && (o = n, n = o.handler, r = o.selector), r && ke.find.matchesSelector(st, r), n.guid || (n.guid = ke.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
            ...
            a = ut.exec(t[u]) || [], d = g = a[1], f = (a[2] || "").split(".").sort(), d && (h = ke.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, h = ke.event.special[d] || {}, c = ke.extend({
              type: d,
              origType: g,
              data: i,
              handler: n,
        ...
        remove: function remove(e, t, n, i, r) {
          ...
          if (m && (l = m.events)) {
            for (t = (t || "").match(qe) || [""], u = t.length; u--;) {
              if (a = ut.exec(t[u]) || [], d = g = a[1], f = (a[2] || "").split(".").sort(), d) {
                for (h = ke.event.special[d] || {}, d = (i ? h.delegateType : h.bindType) || d, p = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) {
                  c = p[o], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, h.remove && h.remove.call(e, c));
                }
        ...
        dispatch: function dispatch(e) {
          ...
          if (a.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, a) !== !1) {
            for (s = ke.event.handlers.call(this, a, u), t = 0; (r = s[t++]) && !a.isPropagationStopped();) {
              for (a.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !a.isImmediatePropagationStopped();) {
                a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, i = ((ke.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l), void 0 !== i && (a.result = i) === !1 && (a.preventDefault(), a.stopPropagation()));
              }
            }
        ...
        handlers: function handlers(e, t) {
          ...
          if (l && u.nodeType && !("click" === e.type && e.button >= 1)) for (; u !== this; u = u.parentNode || this) {
            if (1 === u.nodeType && ("click" !== e.type || u.disabled !== !0)) {
              for (o = [], s = {}, n = 0; n < l; n++) {
                i = t[n], r = i.selector + " ", void 0 === s[r] && (s[r] = i.needsContext ? ke(r, this).index(u) > -1 : ke.find(r, this, null, [u]).length), s[r] && o.push(i);
              }
      ...
      ke.extend({
        ...
        clone: function clone(e, t, n) {
          ...
          if (!(be.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ke.isXMLDoc(e))) for (s = E(a), o = E(e), i = 0, r = o.length; i < r; i++) {
            P(o[i], s[i]);
          }
          if (t) if (n) for (o = o || E(e), s = s || E(a), i = 0, r = o.length; i < r; i++) {
            O(o[i], s[i]);
          } else O(e, a);
          return s = E(a, "script"), s.length > 0 && k(s, !l && E(e, "script")), a;
        },
        cleanData: function cleanData(e) {
          for (var t, n, i, r = ke.event.special, o = 0; void 0 !== (n = e[o]); o++) {
            if (Fe(n)) {
              if (t = n[Ue.expando]) {
                if (t.events) for (i in t.events) {
                  r[i] ? ke.event.remove(n, i) : ke.removeEvent(n, i, t.handle);
                }
                n[Ue.expando] = void 0;
              }
        ...
        empty: function empty() {
          for (var e, t = 0; null != (e = this[t]); t++) {
            1 === e.nodeType && (ke.cleanData(E(e, !1)), e.textContent = "");
          }
        ...
        html: function html(e) {
          return Ie(this, function (e) {
            ...
            if ("string" == typeof e && !ht.test(e) && !rt[(nt.exec(e) || ["", ""])[1].toLowerCase()]) {
              ...
              try {
                for (; n < i; n++) {
                  t = this[n] || {}, 1 === t.nodeType && (ke.cleanData(E(t, !1)), t.innerHTML = e);
                }
        ...
        ke.fn[e] = function (e) {
          for (var n, i = [], r = ke(e), o = r.length - 1, s = 0; s <= o; s++) {
            n = s === o ? this : this.clone(!0), ke(r[s])[t](n), fe.apply(i, n.get());
          }
        ...
        style: function style(e, t, n, i) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var r,
                ...
                l = yt.test(t),
                u = e.style;
            return l || (t = B(a)), s = ke.cssHooks[t] || ke.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t] : (o = _typeof(n), "string" === o && (r = Ze.exec(n)) && r[1] && (n = _(e, t, r), o = "number"), null != n && n === n && ("number" === o && (n += r && r[3] || (ke.cssNumber[a] ? "" : "px")), be.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n)), void 0);
          }
        },
      ...
      ke.Animation = ke.extend(K, {
        ...
        tweener: function tweener(e, t) {
          ...
          for (var n, i = 0, r = e.length; i < r; i++) {
            n = e[i], K.tweeners[n] = K.tweeners[n] || [], K.tweeners[n].unshift(t);
          }
        },
        prefilters: [J],
        ...
        var i = e && "object" == _typeof(e) ? ke.extend({}, e) : {
        ...
        finish: function finish(e) {
          return e !== !1 && (e = e || "fx"), this.each(function () {
            ...
            for (n.finish = !0, ke.queue(this, e, []), r && r.stop && r.stop.call(this, !0), t = o.length; t--;) {
      ...
      ke.fn.extend({
        ...
        addClass: function addClass(e) {
          ...
          if (t = ne(e), t.length) for (; n = this[l++];) {
        ...
        toggleClass: function toggleClass(e, t) {
          ...
          return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : _e(e) ? this.each(function (n) {
            ...
            var t, r, o, s;
            if (i) for (r = 0, o = ke(this), s = ne(e); t = s[r++];) {
              o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
            } else void 0 !== e && "boolean" !== n || (t = te(this), t && Ue.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Ue.get(this, "__className__") || ""));
          });
        },
      ...
      ke.fn.extend({
        ...
        valHooks: {
          ...
          select: {
            ...
            set: function set(e, t) {
              for (var n, i, r = e.options, o = ke.makeArray(t), s = r.length; s--;) {
                i = r[s], (i.selected = ke.inArray(ke.valHooks.option.get(i), o) > -1) && (n = !0);
              }
      ...
      ke.extend(ke.event, {
        trigger: function trigger(e, t, i, r) {
          ...
          if (s = p = a = i = i || ce, 3 !== i.nodeType && 8 !== i.nodeType && !$t.test(f + ke.event.triggered) && (f.indexOf(".") > -1 && (g = f.split("."), f = g.shift(), g.sort()), u = f.indexOf(":") < 0 && "on" + f, e = e[ke.expando] ? e : new ke.Event(f, "object" == _typeof(e) && e), e.isTrigger = r ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : ke.makeArray(t, [e]), h = ke.event.special[f] || {}, r || !h.trigger || h.trigger.apply(i, t) !== !1)) {
            if (!r && !h.noBubble && !Ce(i)) {
              for (l = h.delegateType || f, $t.test(l + f) || (s = s.parentNode); s; s = s.parentNode) {
                d.push(s), a = s;
              }
            ...
            for (o = 0; (s = d[o++]) && !e.isPropagationStopped();) {
              p = s, e.type = o > 1 ? l : h.bindType || f, c = (Ue.get(s, "events") || {})[e.type] && Ue.get(s, "handle"), c && c.apply(s, t), c = u && s[u], c && c.apply && Fe(s) && (e.result = c.apply(s, t), e.result === !1 && e.preventDefault());
            }
      ...
      be.cors = !!Kt && "withCredentials" in Kt, be.ajax = Kt = !!Kt, ke.ajaxTransport(function (e) {
        ...
        if (be.cors || Kt && !e.crossDomain) return {
          send: function send(r, o) {
            ...
            _t3 = function t(e) {
              return function () {
                _t3 && (_t3 = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Qt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                  binary: a.response
                } : {
                  text: a.responseText
      ...
      ke.ajaxSetup({
        ...
        var i,
            ...
            s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = ee(e.slice(a)), e = e.slice(0, a)), _e(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (r = "POST"), s.length > 0 && ke.ajax({
          url: e,
          type: r || "GET",
          dataType: "html",
          data: t
        ...
        position: function position() {
          if (this[0]) {
            ...
            if ("fixed" === ke.css(i, "position")) t = i.getBoundingClientRect();else {
              for (t = this.offset(), n = i.ownerDocument, e = i.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === ke.css(e, "position");) {
                e = e.parentNode;
              }
        ...
        var n, i, r;
        if ("string" == typeof t && (n = e[t], t = e, e = n), _e(e)) return i = pe.call(arguments, 2), r = function r() {
    ...
    function o(e) {
      ...
      } else i = r(), t = a.bind(null, i), n = function n() {
        i.parentNode.removeChild(i);
      };
      ...
      !function (e, n, i, r) {
        ...
        o.Defaults = {
          ...
          run: function run(e) {
            ...
            if (n && e.items.merge) for (; t--;) {
              e.css.width = this._widths[this.relative(t)], i.eq(t).css(e.css);
          ...
          return this.each(function () {
            ...
            r || (r = new o(this, "object" == _typeof(t) && t), i.data("owl.carousel", r), e.each(["next", "prev", "to", "destroy", "refresh", "replace", "add", "remove"], function (t, n) {
              r.register({
                type: o.Type.Event,
                name: n
          ...
          this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": e.proxy(function (t) {
              if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type)) {
                ...
                for (n.lazyLoadEager > 0 && (r += n.lazyLoadEager, n.loop && (s -= n.lazyLoadEager, r++)); o++ < r;) {
                  this.load(a / 2 + this._core.relative(s)), a && e.each(this._core.clones(this._core.relative(s)), l), s++;
                }
              }
            }, this)
          }, this._core.options = e.extend({}, r.Defaults, this._core.options), this._core.$element.on(this._handlers);
