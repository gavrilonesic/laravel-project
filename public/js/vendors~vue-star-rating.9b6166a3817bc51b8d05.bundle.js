(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~vue-star-rating"],{
...
!function (t, e) {
  ...
  return function (t) {
    ...
    function o(t) {
      ...
      } else n = i(), e = s.bind(null, n), r = function r() {
        n.parentNode.removeChild(n);
      };
    ...
    e["default"] = {
      ...
      methods: {
        setRating: function setRating(t, e) {
          if (!this.readOnly) {
    ...
    Object.defineProperty(e, "__esModule", {
      ...
      methods: {
        mouseMoving: function mouseMoving(t) {
      ...
      render: function render() {
        ...
        return r("div", {
          ...
          return r("span", {
            ...
            on: {
              "star-selected": function starSelected(e) {
                t.setRating(e, !0);
              },
