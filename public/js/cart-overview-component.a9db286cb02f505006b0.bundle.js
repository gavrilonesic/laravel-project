...
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/babel-loader/lib??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/cart/CartOverviewComponent.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    cartItems: function cartItems(newValue) {
      this.$root.$emit('cartContentLoaded', newValue);
    },
    scrollY: function scrollY(newValue) {
      var newTop = this.scrollY + this.top - this.originalTop;
      var newSecondaryTop = newTop;
      ...
      if (this.shouldStick) {
        ...
        if (newSecondaryTop < 0) {
          this.myStyle = "width: ".concat(this.containerWidth, "px; top: ").concat(newSecondaryTop, "px; position: fixed; z-index: 100;");
        }
      }
    }
  },
  mounted: function mounted() {
    ...
    if (!isMobile()) {
      window.addEventListener('scroll', function (event) {
        _this.scrollY = Math.round(window.scrollY);
      });
    }

    this.refresh();
    this.$root.$on('paymentMethodUpdated', function (paymentMethod) {
      _this.ccPreviewShow = paymentMethod == 'credit_card';
    });
    ...
    if (!isMobile()) {
      ...
      this.myStyle = "width: ".concat(this.containerWidth, "px; top: ").concat(this.top, "px; position: fixed; z-index: 100;");
    }
  },
  methods: {
  ...
  computed: {
    ...
    shipStationShippingPrice: function shipStationShippingPrice() {
      try {
        var cost = 0;
        var otherCost = 0;
...
var render = function() {
  ...
  return _c("div", { style: _vm.shouldStick ? _vm.myStyle : "" }, [
    _c(
      "h1",
      { staticClass: "font-weight-normal text-dark mb-4 line-height-1-1 h3" },
    ...
    _vm.totalItems > 0
      ? _c("div", [
          _c(
            "h2",
            {
              staticClass: "font-weight-light text-dark mb-3 line-height-1-1 h5"
            },
            [_vm._v("Items To Ship")]
          ),
          _vm._v(" "),
          _c("div", { staticClass: "p-2 bg-white border-muted-6" }, [
            _c(
              "table",
              {
                staticClass:
                  "table-sm table-hovered table-borderless mb-3 w-100"
              },
              [
                _c(
                  "tbody",
                      ...
                      [
                            ...
                            "a",
                            {
                              ...
                              attrs: {
                                href: _vm
                                  .route(
                                    "product.show",
                                    cartItem.attributes.slug !== undefined &&
                                      cartItem.attributes.slug !== null
                                      ? cartItem.attributes.slug
                                      : cartItem.attributes.id
                                  )
                                  .url()
                              }
                            },
                        ...
                        _c("td", { staticClass: "align-middle" }, [
                          _c(
                            "button",
                            {
                              staticClass: "btn btn-sm p-0 text-default small",
                              attrs: { type: "button" },
                              on: {
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass:
                            "align-top py-0 font-weight-bolder text-darker",
                          attrs: { colspan: "2" }
                        },
                        [_vm._v("Total")]
                      ),
                      ...
                      _c("div", [
                        _c(
                          "code",
                          {
                            staticClass: "font-weight-bolder py-0 text-darker"
                          },
    ...
    _c("div", [
      _c("div", {
        staticClass: "row card-wrapper mt-4",
        class: this.ccPreviewShow ? "d-block" : "d-none"
      })
    ])
  ])
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_babel_loader_lib_index_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CartOverviewComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/babel-loader/lib??ref--11-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./CartOverviewComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/cart/CartOverviewComponent.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_babel_loader_lib_index_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CartOverviewComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
