      ...
      _c(
        ...
        [
                ...
                _c(
                  ...
                  [
                    _c(
                      "div",
                      {
                        staticClass: "px-4 pt-4 d-flex flex-column",
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "text-left card-title font-weight-bold font-open-poppins h6 mb-auto mt-0"
                          },
                          [
                            _c(
                              "a",
                              {
                                staticClass:
                                  "text-dark-2 d-block mb-2 font-family-open-sans font-size-1-7rem",
                                attrs: {
                              ...
                              [
                                _vm._v(
                                  "\n\t\t\t                        " +
                                    _vm._s(
                                      _vm._f("truncate")(_vm.product.name, 45)
                                    ) +
                                    "\n\t\t\t                    "
                                )
                              ]
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "mb-0 mt-2 d-flex flex-row align-items-center justify-content-between font-family-open-sans"
                          },
                          [
                            _c(
                              "span",
          ...
          _c(
            ...
            {
              staticClass:
                "px-2 pb-4 text-center d-flex flex-row mt-auto mb-0 align-self-end align-items-center justify-content-between w-100"
            },
            [
              _c(
                "div",
                { staticClass: "w-100 d-flex flex-column max-w-180px ml-2" },
                [
                  _c("div", { staticClass: "btn-group mt-2" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "btn btn-outline-green px-4 py-2 text-uppercase max-w-169px mx-auto",
                        attrs: { href: _vm.productLink }
                      },
                      [
                        _c(
